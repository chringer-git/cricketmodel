...
set_cricket_game <- function(p1, p2) {
  ...
  shot_record <- data.table::data.table(
    ...
    "player_1_20_open" = TRUE,
    "player_1_19_open" = TRUE,
    "player_1_18_open" = TRUE,
    "player_1_17_open" = TRUE,
    "player_1_16_open" = TRUE,
    "player_1_15_open" = TRUE,
    "player_1_bull_open" = TRUE,
    "player_1_points" = 0,
    ...
    "player_2_20_open" = TRUE,
    "player_2_19_open" = TRUE,
    "player_2_18_open" = TRUE,
    "player_2_17_open" = TRUE,
    "player_2_16_open" = TRUE,
    "player_2_15_open" = TRUE,
    "player_2_bull_open" = TRUE,
    "player_2_points" = 0,
