udpate_shot_record <- function(gm) {
  ...
  shot_record <- data.table::data.table(
    ...
    "player_1_20_close" = gm$p1$marks[bed_name == "20"]$open,
    "player_1_19_close" = gm$p1$marks[bed_name == "19"]$open,
    "player_1_18_close" = gm$p1$marks[bed_name == "18"]$open,
    "player_1_17_close" = gm$p1$marks[bed_name == "17"]$open,
    "player_1_16_close" = gm$p1$marks[bed_name == "16"]$open,
    "player_1_15_close" = gm$p1$marks[bed_name == "15"]$open,
    "player_1_bull_close" = gm$p1$marks[bed_name == "Bull"]$open,
    ...
    "player_2_20_close" = gm$p2$marks[bed_name == "20"]$open,
    "player_2_19_close" = gm$p2$marks[bed_name == "19"]$open,
    "player_2_18_close" = gm$p2$marks[bed_name == "18"]$open,
    "player_2_17_close" = gm$p2$marks[bed_name == "17"]$open,
    "player_2_16_close" = gm$p2$marks[bed_name == "16"]$open,
    "player_2_15_close" = gm$p2$marks[bed_name == "15"]$open,
    "player_2_bull_close" = gm$p2$marks[bed_name == "Bull"]$open,
